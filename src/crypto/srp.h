...
RIST_PRIV void librist_crypto_srp_authenticator_get_key(struct librist_crypto_srp_authenticator_ctx *ctx, uint8_t key[SHA256_DIGEST_LENGTH]);
...
RIST_PRIV void librist_crypto_srp_client_get_key(struct librist_crypto_srp_client_ctx *ctx, uint8_t key[SHA256_DIGEST_LENGTH]);
